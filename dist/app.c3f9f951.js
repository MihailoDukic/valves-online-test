...
var stickyHeader = document.querySelector('#sticky-desktop-header');
var iconScroll = document.querySelector('#hamburger-scroll');
var sticky = stickyHeader.offsetTop;
var showIcon = iconScroll.offsetTop;
...
var swiper = new _swiperBundle.default('.swiper', {
  loop: true,
  slidesPerView: 2,
  spaceBetween: 60,
  navigation: {
...
var menuDesktopToggleF = document.querySelector('#hamburger-scroll');
var menuDesktopToggle = document.querySelector('#hamburger-static-toggle');
var menuDesktopF = document.querySelector('#desktop-menu');
menuDesktopToggleF.addEventListener('click', function () {
  menuDesktopF.classList.toggle('show-fixed-menu');
});
menuDesktopToggle.addEventListener('click', function () {
  menuDesktopF.classList.toggle('show-static-menu');
}); // Open Close Mobile Menu 

var mobileNav = document.querySelector('#mobile-nav');
var openMobileNav = document.querySelector('#open-mobile-menu');
var closeMobileNav = document.querySelector('#close-mobile-menu'); // Open Close Inner Mobile Menu 

var innerToggleOne = document.querySelector('#inner-m-toggle-one');
var innerToggleTwo = document.querySelector('#inner-m-toggle-two');
var innerToggleThree = document.querySelector('#inner-m-toggle-three');
var innerMenuOne = document.querySelector('#inner-m-one');
var innerMenuTwo = document.querySelector('#inner-m-two');
var innerMenuThree = document.querySelector('#inner-m-three');
var arrowMOne = document.querySelector('#arrow-m-one');
var arrowMTwo = document.querySelector('#arrow-m-two');
var arrowMThree = document.querySelector('#arrow-m-three'); // Open Close Mobile Menu 
...
innerToggleOne.addEventListener('click', function () {
...
innerToggleTwo.addEventListener('click', function () {
...
innerToggleThree.addEventListener('click', function () {
...
var productsInfo = document.querySelectorAll('#prod-info');
productsInfo.forEach(function (box) {
  box.addEventListener('click', function () {
    if (document.body.clientWidth <= 680) {
      var prodContent = box.querySelector('#prod-content');
      var prodArrow = box.querySelector('#prod-arrow');
...
var fBoxes = document.querySelectorAll('#content');
fBoxes.forEach(function (box) {
  box.addEventListener('click', function () {
    if (document.body.clientWidth <= 980) {
      var fList = box.querySelector('#link-list');
      var fToggle = box.querySelector("#toggle-list");
      var fArrow = box.querySelector('#arrow-footer');
...
},{"swiper/swiper-bundle":"../node_modules/swiper/swiper-bundle.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
